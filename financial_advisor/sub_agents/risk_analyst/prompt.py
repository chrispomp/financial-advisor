...
RISK_ANALYST_PROMPT = """
Objective: Generate a detailed and reasoned risk analysis for the provided trading strategy, execution strategy, daily briefing or market roundup.
...
Brief overview of the most critical risks identified for the combined trading and execution strategies, daily briefing or market roundup, specifically contextualized
...
inflation impact, currency risk if applicable, correlation breakdown) directly pertinent to the provided_trading_strategy, daily briefing or market roundup and
the assets involved.
...
provided_trading_strategy, daily briefing or market roundup, considering their typical trading volumes, bid-ask spreads, and potential market stress scenarios.
...
Identification: Pinpoint risks inherent to the logic and assumptions of the provided_trading_strategy, provided_execution_strategy, daily briefing or market roundup
...
Conclude with an explicit discussion summarizing how the overall risk profile of the combined strategies, daily briefing or market roundup, taking into account all identified
